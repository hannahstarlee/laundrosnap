...
import { Camera, Heart, MessageCircle, Sparkles, Clock, Loader2, Award, Zap } from "lucide-react"
...
export function LaundrosnapFeed() {
  ...
  return (
    <div className="max-w-md mx-auto bg-gradient-to-b from-blue-100 to-purple-100 min-h-screen relative overflow-hidden">
      ...
      {/* Footer Navigation */}
      <footer className="bg-white p-4 shadow-inner sticky bottom-0">
